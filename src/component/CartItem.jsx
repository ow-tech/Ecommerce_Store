         ...
         <Card 
            ...
            >
                ...
                <div>
                    <Row justify="center">  
                    <Space>
                        <Button offset={12}type="button"value="small"><MinusOutlined /></Button>
                       
                    <Typography span={5}variant="h5"level={5}>{item.quantity}</Typography>
                    <Button span={5} type="button" value="small"><PlusOutlined /></Button>
                    </Space>
                    </Row>
                   
                </div>
                <Row justify="center" span={5}>
                <Button align="center" type="text" danger>Remove Item</Button>
                </Row>
            </Card>
